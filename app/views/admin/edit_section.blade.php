  ...
  <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              {{ Form::open(array('method' => 'put', 'action' => array('AdminController@updateSection', $section->id))) }}
       ...
       <div class="form-group{{ ($errors->has('name')) ? ' has-error' : '' }}">
			...
			<input id="Name" name="name" type="text" placeholder = "{{$section->name}}"class="form-control">
			@if($errors->has('name'))
			{{ $errors->first('name') }}
			@endif
