...
@section('content')
 ...
 <form role="form" method="post" action="{{ URL::route('viewAttendanceRecorded') }}">
  ...
  {{ Form::label('section_name', 'Choose a Section:') }}
     ...
     <div class="form-group">
  {{ Form::label('subject_code', 'Choose a Subject Code:') }}
  ...
  {{ Form::token() }}
    ...
    <div class="form-group">
    <input type="submit" value="View Attendance Record" class="btn btn-primary">
  </form>
  </div>
        @if ($errors->any())
          <ul>
